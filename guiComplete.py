...
def callfunc(list1):
    def makeWindow () :
        ...
        frame2.pack()
        b1 = Button(frame2,text=" Click  ",bg = 'yellow',foreground = 'black',command = lambda : func(int(e1.get())))
        b1.pack(side = LEFT)
...
def startWindow() :
    ...
    f1 = Frame(wind)
    f1.pack()
    label1 = Label(f1, text='PRESS OKAY TO\n CAPTURE IMAGE\n ', width = 29, height = 3, font = 'algerian', bg = 'indian red')
    label1.pack()
    
    f2 = Frame(wind)
    f2.pack()
    button = Button(f2, text='Okay', bg ='purple2',foreground = 'gold', font = 'algerian',command = CaptureImage)
...
def offline():
    ...
    test_image = tf.keras.utils.load_img('img.jpeg', target_size = (64, 64),grayscale=1)
...
def online():
    ...
    if result[0][1] ==1 :
        ...
        if x == 0:
            ...
            webbrowser.open('https://www.youtube.com/watch?v=1JDOJpB10hE')
        elif x==2:
            webbrowser.open('https://www.youtube.com/watch?v=38fhj9tFfAQ')
        elif x==3:
        ...
        prediction="Sad"
        if x == 0:
            webbrowser.open('https://www.youtube.com/watch?v=I9WmFIW7lsM')
        elif x== 1:
            webbrowser.open('https://www.youtube.com/watch?v=ttfkacMIF8I')
        elif x==2:
            webbrowser.open('https://www.youtube.com/watch?v=Ct9e00Cts94&list=RDEMWdyzRk_qKD6b8NZqiletrw&index=2')
        elif x==3:
        ...
        prediction="Exciting"
        if x == 0:
            webbrowser.open('https://www.youtube.com/watch?v=nCJRbVhKQy4&list=RDMM&start_radio=1&rv=Ct9e00Cts94')
        elif x== 1:
            webbrowser.open('https://www.youtube.com/watch?v=FSuGx2758Y4')
        elif x==2:
            webbrowser.open('https://www.youtube.com/watch?v=1fd7pk1fT8g')
        elif x==3:
